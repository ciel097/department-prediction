...
str_per = str(per) 
str_pie = f'이 그래프는 {year}년 부서별 민원 요청 비율을 보여주며, {str_pie_dept1}가 {str_per:.2%}%로 가장 많은 민원을 받았습니다. {str_pie_dept2}와 {str_pie_dept3}가 그 뒤를 잇고 있으며, 일부 부서는 상대적으로 낮은 비율을 기록했습니다.'
st.caption(str_pie)
###############################################
